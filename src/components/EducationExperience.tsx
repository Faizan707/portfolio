...
const EducationExperience = () => {
  ...
  return (
    <section className="w-full bg-black py-12 md:py-16 px-4 md:px-6">
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-gray-300 text-base font-semibold uppercase tracking-wide">
                {education[0].year}
              </h3>
            </div>
            {education[0].entries.map((entry, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 hover:border-blue-500/50 hover:bg-gray-900 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <h4 className="text-white text-lg md:text-xl font-bold group-hover:text-blue-300 transition-colors">
                          {entry.title}
                        </h4>
            ...
            {experience[0].entries.map((entry, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 hover:border-green-500/50 hover:bg-gray-900 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <h4 className="text-white text-lg md:text-xl font-bold group-hover:text-green-300 transition-colors">
                          {entry.title}
                        </h4>
                        <p className="text-gray-400 text-sm md:text-base">
                          {entry.detail}
            ...
            {experience[1].entries.map((entry, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 hover:border-purple-500/50 hover:bg-gray-900 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <h4 className="text-white text-lg md:text-xl font-bold group-hover:text-purple-300 transition-colors">
                          {entry.title}
                        </h4>
                        <p className="text-gray-400 text-sm md:text-base">
                          {entry.detail}
